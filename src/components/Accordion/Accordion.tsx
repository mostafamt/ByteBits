...
const services = [
  ...
  },
  {
    header: (
      <>
        <span>AI</span> Integration
      </>
    ),
    closedText: `Filler Ipsum`,
    openText: `        Normally, both your asses would be dead as fucking fried chicken, but you happen to pull
